...
public class CgsAttachments {
    ...
    public static final DeferredHolder<Item> SCOPE = ITEMS.register("scope",
            () -> new ScopeItem(LONG_SCOPE, ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> STOCK = ITEMS.register("stock",
            () -> new AttachmentItem<>(AttachmentType.STOCK, GenericAttachment.create(AttachmentMods.STOCK), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> BAYONET = ITEMS.register("bayonet",
            () -> new AttachmentItem<>(AttachmentType.MUZZLE,
                    GenericAttachment.create(AttachmentMods.BAYONET_MODIFIERS), ITEM_PROPERTIES));

    //FLINTLOCK
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> FLINTLOCK_LONG_BARREL = ITEMS.register("flintlock_long_barrel",
            () -> new BarrelItem(Barrel.create(11f, AttachmentMods.LONG_BARREL), ITEM_PROPERTIES));

//    @ItemModelGen(path = "attachments")
//    public static final DeferredHolder<Item> FLINTLOCK_MORTAR_BARREL = ITEMS.register("flintlock_mortar_barrel",
//            () -> new BarrelItem(Barrel.create(5f, AttachmentMods.MORTAR_BARREL), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> BLUNDERBUSS_BARREL = ITEMS.register("blunderbuss_barrel",
            () -> new BarrelItem(Barrel.create(5f, AttachmentMods.BLUNDERBUSS_BARREL), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> LONG_BLUNDERBUSS_BARREL = ITEMS.register("blunderbuss_barrel_long",
            () -> new BarrelItem(Barrel.create(10f, AttachmentMods.LONG_BLUNDERBUSS_BARREL), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> REVOLVING_CHAMBERS = ITEMS.register("flintlock_chambers",
            () -> new AttachmentItem<>(AttachmentType.MAGAZINE, GenericAttachment.create(AttachmentMods.REVOLVING_CHAMBERS), ITEM_PROPERTIES));

    //REVOLVER
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> REVOLVER_LONG_BARREL = ITEMS.register("long_barrel",
            () -> new BarrelItem(Barrel.create(11f, AttachmentMods.LONG_BARREL), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> REVOLVER_BELT = ITEMS.register("round_belt",
            () -> new AttachmentItem<>(CgsAttachmentTypes.CHAMBER,
                    GenericAttachment.create(BELT_MODIFIERS), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> REVOLVER_AUTO = ITEMS.register("auto_fire",
            () -> new AttachmentItem<>(CgsAttachmentTypes.FRAME,
                    GenericAttachment.create(AUTO_FIRE), ITEM_PROPERTIES));

    //SHOTGUN
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> SHOTGUN_DRUM = ITEMS.register("shotgun_drum",
    ...
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> SHOTGUN_PUMP = ITEMS.register("shotgun_pump",
            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
                    GenericAttachment.create(SHOTGUN_PUMP_MODIFIER, SHOTGUN_MODIFIER), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> SHOTGUN_LONG_BARREL = ITEMS.register("shotgun_long_barrel",
            () -> new BarrelItem(Barrel.create(11f, AttachmentMods.SHOTGUN_LONG_BARREL), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> SHOTGUN_SPREAD_BARREL = ITEMS.register("shotgun_spread_barrel",
            () -> new BarrelItem(Barrel.create(1f, AttachmentMods.SHOTGUN_SPREAD_BARREL), ITEM_PROPERTIES));

    //GATLING
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> STEAM_ENGINE = ITEMS.register("steam_engine",
            () -> new AttachmentItem<>(ENGINE, GenericAttachment.create(STEAM_ENGINE_MODIFIERS), ITEM_PROPERTIES));

//    @ItemModelGen(path = "attachments")
//    public static final DeferredHolder<Item> IRON_SIGHT = ITEMS.register("iron_sight",
//            () -> new ScopeItem(SHORT_SCOPE, ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> GATLING_DRUM = ITEMS.register("gatling_drum",
            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
                    GenericAttachment.create(GATLING_DRUM_MODIFIERS), ITEM_PROPERTIES));

    //NAILGUN
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> NAILGUN_SPLITTER = ITEMS.register("nailgun_splitter",
            () -> new BarrelItem(Barrel.create(1f, AttachmentMods.NAILGUN_SPLIT_BARREL), ITEM_PROPERTIES));

//    //BLAZEGUN
//    @ItemModelGen(path = "attachments")
//    public static final DeferredHolder<Item> POTION_TANK = ITEMS.register("potion_tank",
//            () -> new AttachmentItem<>(CgsAttachmentTypes.FRAME,
//                    GenericAttachment.create(), ITEM_PROPERTIES));

    //LAUNCHER
//    @ItemModelGen(path = "attachments")
//    public static final DeferredHolder<Item> ROCKET_CONTAINER = ITEMS.register("rocket_container",
//            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
//                    GenericAttachment.create(), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> AUTO_LAUNCHER = ITEMS.register("launcher_auto",
            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
                    GenericAttachment.create(AttachmentMods.AUTO_LAUNCHER), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> BALLISTAZOOKA = ITEMS.register("ballistazooka",
            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
                    GenericAttachment.create(AttachmentMods.BALLISTAZOOKA), ITEM_PROPERTIES));

//    @ItemModelGen(path = "attachments")
//    public static final DeferredHolder<Item> HOOK_LAUNCHER = ITEMS.register("launcher_hook",
//            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
//                    GenericAttachment.create(), ITEM_PROPERTIES));

//    @ItemModelGen(path = "attachments")
//    public static final DeferredHolder<Item> ITEM_LAUNCHER = ITEMS.register("item_launcher",
//            () -> new AttachmentItem<>(AttachmentType.MAGAZINE,
//                    GenericAttachment.create(), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> LAUNCHER_BAYONET = ITEMS.register("big_bayonet",
            () -> new AttachmentItem<>(AttachmentType.MUZZLE,
                    GenericAttachment.create(AttachmentMods.BIG_BAYONET), ITEM_PROPERTIES));

    //HAMMER
    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> HAMMER_CHAMBER = ITEMS.register("hammer_chamber",
            () -> new AttachmentItem<>(AttachmentType.MAGAZINE, GenericAttachment.create(RECIEVER), ITEM_PROPERTIES));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> HAMMER_STONE = ITEMS.register("hammer_stone",
            () -> new HammerHeadItem(Tiers.STONE, HammerHeadItem.Type.HAMMER, GenericAttachment.create(HAMMER_HEAD), new Item.Properties()));

    @ItemModelGen(path = "attachments")
    public static final DeferredHolder<Item> HAMMER_IRON = ITEMS.register("hammer_iron",
